...
int main(int, char **)
{
    ...
    while (!done)
    {
...

        {
            ...
            ImGui::Begin("Hello, world!", &mainwindows,window_flags); // Create a window called "Hello, world!" and append into it.
        ...
        if (show_another_window)
        {
            ...
            Funcs::MyInputTextMultiline("##MyStr", &my_str, ImVec2(ImGui::GetTextLineHeight() * 16, ImGui::GetTextLineHeight() * 16));
